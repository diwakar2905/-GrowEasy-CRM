...
exports.getSummaryUserPrompt = exports.getExtractionUserPrompt = exports.SYSTEM_PROMPT = void 0;
...
`;
const getExtractionUserPrompt = (records) => {
    return `
...
exports.getExtractionUserPrompt = getExtractionUserPrompt;
const getSummaryUserPrompt = (stats) => {
    return `
