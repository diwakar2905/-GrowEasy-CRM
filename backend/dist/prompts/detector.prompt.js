...
exports.getDetectorUserPrompt = exports.DETECTOR_SYSTEM_PROMPT = void 0;
exports.DETECTOR_SYSTEM_PROMPT = `
...
`;
const getDetectorUserPrompt = (headers, sampleRows) => {
    return `
...
exports.getDetectorUserPrompt = getDetectorUserPrompt;
